...
def model_generation(model_params: dict) -> dict:
    ...
    with open("templates/code-templates/model_func.json") as file:
            ...
            if node["id"] not in visited:
                ...
                for added_node in starter_json["config"]["layers"]:
                    if added_node["name"] == node["id"]:
                        added_node["inbound_nodes"].append([current_node["id"], 0, 0, {}])
...
def helper_generate_layers(layer_params: dict) -> dict:

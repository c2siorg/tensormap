...
function ConvNode({ data, id }) {
            ...
            Array.from(nodeInternals.values()).map((node) => {
                if (node.id === id) {
                    node.data = {
                        ...
                        params: {
                            ...node.data.params,
                            [name]: name === "filter" || name === "strideX" || name === "strideY" ? Number(value) : value,
                        },
                    };
                }
                console.log(node);
    ...
    return (
        <div className="conv-node">
            ...
            <select id="padding" className="padding" name="padding" onChange={updateNodeState} value={data.params.padding}>

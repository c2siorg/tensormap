...
from app.routers import data_process, data_quality, data_upload, deep_learning, health, project
...
app.include_router(data_quality.router, prefix=settings.api_base)
